# Open Questions Report — Demo Online-Shop (transaktional, KI-Assistent)
...
## Unklare Anwendbarkeit (0)

_Keine offenen Punkte._

## Rechtlicher Prüfbedarf (9)
...
- `applicability_assessment:asmt-eu_data_act-profile-demo-shop-2026-09-16` — EU_DATA_ACT: needsLegalReview gesetzt, aber noch kein reviewedBy/reviewedAt erfasst. (§6.6, F-16)
