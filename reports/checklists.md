# Compliance-Checklisten — Demo Online-Shop (transaktional, KI-Assistent)
...
|---|---|---|---|---|---|---|
| [~] | Accessibility-Struktur im Layout vorhanden | accessibility | `in_progress` | – | ja | – |
| [~] | Footer-Slot für AccessibilityStatement vorhanden | architecture | `prepared` | ja | – | – |
| [ ] | Feedback- oder Kontaktmechanismus vorbereitet | accessibility | `not_started` | – | ja | – |
| [~] | Alternativzugänge berücksichtigt | accessibility | `in_progress` | – | ja | – |
| [~] | Farbkontraste prüfbar | testing | `prepared` | – | ja | – |
| [~] | Tastaturbedienung prüfbar | testing | `prepared` | – | ja | – |
| [~] | Formular-Labels vorhanden | accessibility | `in_progress` | – | ja | – |
| [~] | Fokus-States vorhanden | accessibility | `in_progress` | – | ja | – |
| [~] | Semantische Überschriftenstruktur vorhanden | accessibility | `in_progress` | – | ja | – |
| [ ] | Media-Alternativen vorbereitet | content | `not_started` | – | ja | – |
| [~] | Accessibility-Test-Setup vorhanden | testing | `prepared` | – | ja | – |
...
| | Punkt | Kategorie | Status | Rechtstext | Nachweis | Legal Review |
|---|---|---|---|---|---|---|
| [~] | KI-Funktion inventarisiert | documentation | `in_progress` | – | ja | – |
| [~] | KI-Einsatz im Projektprofil erfasst | documentation | `in_progress` | – | – | – |
| [ ] | Chatbot-Kennzeichnung vorbereitet | ai_transparency | `not_started` | ja | ja | – |
| [ ] | Hinweis auf synthetische Inhalte vorbereitet | ai_transparency | `not_started` | ja | ja | – |
| [~] | Kontextuelle Disclosure-Komponente vorbereitet | ai_transparency | `prepared` | ja | – | – |
| [~] | Systembeschreibung als Slot vorhanden | architecture | `prepared` | ja | – | – |
| [ ] | Nutzerhinweis vor Interaktion vorbereitet | ai_transparency | `not_started` | ja | ja | – |
| [ ] | Logging- oder Nachweisstruktur vorbereitet | documentation | `not_started` | – | ja | – |
| [ ] | Rechtstext-Slot nicht eigenmächtig befüllt | content | `not_started` | ja | – | ja |

Erläuterungen:

- **KI-Einsatz im Projektprofil erfasst:** hasAiChatbot / hasAiGeneratedContent / hasAutomatedDecisions sind gepflegt.
